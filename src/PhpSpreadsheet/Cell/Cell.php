...
use PhpSpreadsheet\Shared\Date as SharedDate;
use PhpSpreadsheet\Shared\StringHelper;
use PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType): void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \PhpSpreadsheet\Calculation\Exception("Invalid value $calculateDateTimeType for calculated date time type");
        }
    }
