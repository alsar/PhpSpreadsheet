...
use PhpSpreadsheet\Chart\AxisText;
use PhpSpreadsheet\Chart\ChartColor;
...
use PhpSpreadsheet\Chart\Properties as ChartProperties;
use PhpSpreadsheet\Chart\Title;
use PhpSpreadsheet\Chart\TrendLine;
...
class Chart
{
    ...
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
