...
use PhpSpreadsheet\Calculation\Information\ErrorValue;
...
use PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBar;
use PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
...
class Worksheet extends WriterPart
{
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $worksheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$worksheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)
