...
class Html extends BaseWriter
{
    ...
    public function generateHTMLHeader($includeStyles = false)
    {
        ...
        $html .= '      <meta name="generator" content="PhpSpreadsheet, https://github.com/alsar/PhpSpreadsheet" />' . PHP_EOL;
     ...
     *
     * @param Worksheet $worksheet \PhpSpreadsheet\Worksheet\Worksheet
