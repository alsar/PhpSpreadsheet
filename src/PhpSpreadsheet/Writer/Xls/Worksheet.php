...
class Worksheet extends BIFFwriter
{
     ...
     *
     * @var null|\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
    ...
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParentOrThrow()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\PhpSpreadsheet\Shared\Escher
    {
        return $this->escher;
    }
     ...
     * Set Escher object.
     */
    public function setEscher(?\PhpSpreadsheet\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
