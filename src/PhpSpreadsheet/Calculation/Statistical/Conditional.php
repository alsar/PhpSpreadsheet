...
namespace PhpSpreadsheet\Calculation\Statistical;

use PhpSpreadsheet\Calculation\Database\DAverage;
use PhpSpreadsheet\Calculation\Database\DCount;
use PhpSpreadsheet\Calculation\Database\DMax;
use PhpSpreadsheet\Calculation\Database\DMin;
use PhpSpreadsheet\Calculation\Database\DSum;
use PhpSpreadsheet\Calculation\Exception as CalcException;
