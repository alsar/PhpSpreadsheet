...
use PhpSpreadsheet\Reader\Csv as CsvReader;
use PhpSpreadsheet\Writer\Csv as CsvWriter;

require __DIR__ . '/../Header.php';
$spreadsheet = require __DIR__ . '/../templates/sampleSpreadsheet.php';

$helper->log('Write to CSV format');
/** @var \PhpSpreadsheet\Writer\Csv $writer */
...
/** @var \PhpSpreadsheet\Reader\Csv $reader */
...
/** @var \PhpSpreadsheet\Writer\Csv $writerCSV */
