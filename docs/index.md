...
composer. See the `require` section of [the composer.json file](https://github.com/alsar/PhpSpreadsheet/blob/master/composer.json)
for details.
...
```sh
composer require alsar/PhpSpreadsheet --prefer-source
```
...
```sh
php -S localhost:8000 -t vendor/alsar/PhpSpreadsheet/samples
```
...
```sh
php vendor/alsar/PhpSpreadsheet/samples/Basic/01_Simple.php
```
...
list](https://github.com/alsar/PhpSpreadsheet/graphs/contributors)
