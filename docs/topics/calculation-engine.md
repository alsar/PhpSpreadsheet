...
correctly. Use `\PhpSpreadsheet\Writer\Xls` if you really need
...
```php
\PhpSpreadsheet\Calculation\Functions::setReturnDateType($returnDateType);
```

where the following constants can be used for `$returnDateType`:

- `\PhpSpreadsheet\Calculation\Functions::RETURNDATE_PHP_NUMERIC`
- `\PhpSpreadsheet\Calculation\Functions::RETURNDATE_PHP_OBJECT`
- `\PhpSpreadsheet\Calculation\Functions::RETURNDATE_EXCEL`
...
The `\PhpSpreadsheet\Calculation\Functions::getReturnDateType()`
method can be used to determine the current value of this setting:

```php
$returnDateType = \PhpSpreadsheet\Calculation\Functions::getReturnDateType();
```
...
`\PhpSpreadsheet\Shared\Date::setExcelCalendar()` method:

```php
\PhpSpreadsheet\Shared\Date::setExcelCalendar($baseDate);
```

where the following constants can be used for `$baseDate`:

- `\PhpSpreadsheet\Shared\Date::CALENDAR_WINDOWS_1900`
- `\PhpSpreadsheet\Shared\Date::CALENDAR_MAC_1904`

The method will return a Boolean True on success, False on failure (e.g.
if an invalid value is passed in).

The `\PhpSpreadsheet\Shared\Date::getExcelCalendar()` method can
be used to determine the current value of this setting:

```php
$baseDate = \PhpSpreadsheet\Shared\Date::getExcelCalendar();
```
...
`\PhpSpreadsheet\Shared\Date` class that can help when working
with dates:

#### \PhpSpreadsheet\Shared\Date::excelToTimestamp($excelDate)
...
#### \PhpSpreadsheet\Shared\Date::excelToDateTimeObject($excelDate)

Converts a date from an Excel date/timestamp to return a PHP `DateTime`
object.

#### \PhpSpreadsheet\Shared\Date::PHPToExcel($PHPDate)

Converts a PHP serialized date/timestamp or a PHP `DateTime` object to
return an Excel date timestamp.

#### \PhpSpreadsheet\Shared\Date::formattedPHPToExcel($year, $month, $day, $hours=0, $minutes=0, $seconds=0)
...
#### \PhpSpreadsheet\Shared\Date::getDefaultTimezone()

Returns the current timezone value PhpSpeadsheet is using to handle dates and times.

#### \PhpSpreadsheet\Shared\Date::setDefaultTimezone($timeZone)
...
#### \PhpSpreadsheet\Shared\Date::excelToDateTimeObject($excelDate, $timeZone)
#### \PhpSpreadsheet\Shared\Date::excelToTimeStamp($excelDate, $timeZone)
...
\PhpSpreadsheet\Cell\Cell::setCalculateDateTimeType(\PhpSpreadsheet\Cell\Cell::CALCULATE_DATE_TIME_FLOAT);
// All fields with Time or DateTime styles returned as float.
\PhpSpreadsheet\Cell\Cell::setCalculateDateTimeType(\PhpSpreadsheet\Cell\Cell::CALCULATE_TIME_FLOAT);
// Default - fields with Date, Time, or DateTime styles returned as they had been stored.
\PhpSpreadsheet\Cell\Cell::setCalculateDateTimeType(\PhpSpreadsheet\Cell\Cell::CALCULATE_DATE_TIME_ASIS);
```
...
`\PhpSpreadsheet\Calculation\Functions::getReturnDateType()`.
...
\PhpSpreadsheet\Calculation\Calculation::getInstance()->setCalculationCacheEnabled(FALSE);

$saveFormat = \PhpSpreadsheet\Calculation\Functions::getReturnDateType();
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'DATE'],
    [2008, 12, 31]
);
// $retVal = 39813.0
...
\PhpSpreadsheet\Calculation\Functions::setReturnDateType($saveFormat);
```
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'DATEDIF'],
    [$date1, $date2, 'd']
);
// $retVal = 2966
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'DATEVALUE'],
    ['31-Dec-2008']
);
// $retVal = 39813.0
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'DAYOFMONTH'],
    ['25-Dec-2008']
);
// $retVal = 25
```
...
`\PhpSpreadsheet\Calculation\Functions::DAYOFMONTH()` when the
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'DAYS360'],
    [$date1, $date2]
);
// $retVal = 1558
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'EDATE'],
    ['31-Oct-2008', 25]
);
...
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'EOMONTH'],
    ['31-Oct-2008', 13]
);
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'HOUROFDAY'],
    ['09:30']
);
// $retVal = 9
```
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::HOUROFDAY()` when the
method is called statically.
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'MINUTE'],
    ['09:30']
);
// $retVal = 30
```
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::MINUTE()` when the
method is called statically.
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'MONTHOFYEAR'],
    ['14-July-2008']
);
// $retVal = 7
```
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::MONTHOFYEAR()` when the
method is called statically.
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::DATETIMENOW()` when the
method is called statically.
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'SECOND'],
    ['09:30:17']
);
// $retVal = 17
```
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::SECOND()` when the
method is called statically.
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'WEEKDAY'],
    ['14-July-2008']
);
// $retVal = 7
```
...
Note that the PhpSpreadsheet function is
`\PhpSpreadsheet\Calculation\Functions::WEEKDAY()` when the
method is called statically.
...
```php
$retVal = call_user_func_array(
    ['\PhpSpreadsheet\Calculation\Functions', 'YEAR'],
    ['14-July-2001']
);
// $retVal = 2001
```
