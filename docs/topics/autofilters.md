...
$columnFilter->setFilterType(
    \PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER
);
```
...
$columnFilter->createRule()
    ...
    ->setRuleType(
        \PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule::AUTOFILTER_RULETYPE_DATEGROUP
    );
```
...
```php
$columnFilter->setFilterType(
    \PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_CUSTOMFILTER
);
```
...
$columnFilter->createRule()
    ...
    ->setRuleType(
        \PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule::AUTOFILTER_RULETYPE_CUSTOMFILTER
    );
```
...
$columnFilter->setJoin(
    \PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND
);
```

The valid set of operators for Custom Filters are defined in the
`\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule` class, and
comprise:
...
```php
$columnFilter->setFilterType(
    \PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER
);
```
...
$columnFilter->createRule()
    ...
    ->setRuleType(
        \PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule::AUTOFILTER_RULETYPE_DYNAMICFILTER
    );
```
...
```php
$columnFilter->setFilterType(
    \PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_TOPTENFILTER
);
```
...
$columnFilter->createRule()
    ...
    ->setRuleType(
        \PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule::AUTOFILTER_RULETYPE_TOPTENFILTER
    );
```
