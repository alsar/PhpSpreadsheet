...
namespace PhpSpreadsheetTests\Functional;
...
class ConditionalStopIfTrueTest extends AbstractFunctional
{
    ...
    public function testConditionalStopIfTrue($format): void
    {
        ...
        $condition0 = new \PhpSpreadsheet\Style\Conditional();
        $condition0->setConditionType(\PhpSpreadsheet\Style\Conditional::CONDITION_EXPRESSION);
        ...
        $condition1 = new \PhpSpreadsheet\Style\Conditional();
        $condition1->setConditionType(\PhpSpreadsheet\Style\Conditional::CONDITION_CELLIS);
        $condition1->setOperatorType(\PhpSpreadsheet\Style\Conditional::OPERATOR_LESSTHAN);
        ...
        $condition2 = new \PhpSpreadsheet\Style\Conditional();
        $condition2->setConditionType(\PhpSpreadsheet\Style\Conditional::CONDITION_CELLIS);
        $condition2->setOperatorType(\PhpSpreadsheet\Style\Conditional::OPERATOR_GREATERTHAN);
