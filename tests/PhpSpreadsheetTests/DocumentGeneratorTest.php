...
use PhpSpreadsheet\Calculation\Category as Cat;
use PhpSpreadsheet\Calculation\Functions;
use PhpSpreadsheet\Calculation\Logical;
use PhpSpreadsheetInfra\DocumentGenerator;
        ...
        return [
            [
                ...
                <<<'EXPECTED'
                    ...
                    AND                      | CATEGORY_LOGICAL               | \PhpSpreadsheet\Calculation\Logical::logicalAnd
        ...
        return [
            [
                ...
                <<<'EXPECTED'
                    ...
                    Excel Function           | PhpSpreadsheet Function
                    -------------------------|--------------------------------------
                    AND                      | \PhpSpreadsheet\Calculation\Logical::logicalAnd
