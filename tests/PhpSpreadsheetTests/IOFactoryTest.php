...
class IOFactoryTest extends TestCase
{
    ...
    {
        $this->expectException(\PhpSpreadsheet\Writer\Exception::class);
    ...
    {
        $this->expectException(\PhpSpreadsheet\Reader\Exception::class);
    ...
    public function testCreateReaderUnknownExtension(): void
    {
        ...
        self::assertEquals('PhpSpreadsheet\\Reader\\Csv', get_class($reader));
    }
    ...
    public function testCreateReaderNoExtension(): void
    {
        ...
        $reader = IOFactory::createReaderForFile($filename);
        self::assertEquals('PhpSpreadsheet\\Reader\\Xls', get_class($reader));
    }
