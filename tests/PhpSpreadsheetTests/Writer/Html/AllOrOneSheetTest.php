...
use PhpSpreadsheet\Writer\Pdf\Tcpdf;
...
class AllOrOneSheetTest extends Functional\AbstractFunctional
{
    ...
    public function testPageBreak(): void
    {
        ...
        $sheet->setBreak('A2', \PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW);
    ...
    public function testTcpdfPageBreak(): void
    {
        ...
        $sheet2->setBreak('A2', \PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW);
