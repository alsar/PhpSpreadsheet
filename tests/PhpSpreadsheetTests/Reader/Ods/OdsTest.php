...
class OdsTest extends TestCase
{
    ...
    public function testLoadWorksheets(): void
    {
        ...
        self::assertInstanceOf('PhpSpreadsheet\Spreadsheet', $spreadsheet);

        self::assertEquals(2, $spreadsheet->getSheetCount());

        $firstSheet = $spreadsheet->getSheet(0);
        self::assertInstanceOf('PhpSpreadsheet\Worksheet\Worksheet', $firstSheet);

        $secondSheet = $spreadsheet->getSheet(1);
        self::assertInstanceOf('PhpSpreadsheet\Worksheet\Worksheet', $secondSheet);
    ...
    public function testReadHyperlinks(): void
    {
        ...
        self::assertEquals('https://github.com/alsar/PhpSpreadsheet', $hyperlink->getHyperlink()->getUrl());
        $spreadsheet->disconnectWorksheets();
    }
