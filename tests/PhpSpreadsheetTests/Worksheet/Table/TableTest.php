...
namespace PhpSpreadsheetTests\Worksheet\Table;

use PhpSpreadsheet\Cell\CellAddress;
use PhpSpreadsheet\Cell\CellRange;
use PhpSpreadsheet\Exception as PhpSpreadsheetException;
use PhpSpreadsheet\Worksheet\AutoFilter;
use PhpSpreadsheet\Worksheet\Table;
use PhpSpreadsheet\Worksheet\Table\Column;
...
class TableTest extends SetupTeardown
{
    ...
    public function testSetColumnWithString(): void
    {
        ...
        $result = $table->getColumns();
        //  Result should be an array of \PhpSpreadsheet\Worksheet\Worksheet\Table\Column
    ...
    public function testGetColumn(): void
    {
        ...
        //    get a \PhpSpreadsheet\Worksheet\Worksheet\Table\Column object returned
        foreach ($columnIndexes as $columnIndex) {
    ...
    {
        $this->expectException(\PhpSpreadsheet\Exception::class);
        $table = new Table(self::INITIAL_RANGE);
