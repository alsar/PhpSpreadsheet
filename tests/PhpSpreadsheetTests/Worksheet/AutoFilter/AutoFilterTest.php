...
class AutoFilterTest extends SetupTeardown
{
    ...
    public function testSetColumnWithString(): void
    {
        ...
        $result = $autoFilter->getColumns();
        //  Result should be an array of \PhpSpreadsheet\Worksheet\Worksheet\AutoFilter\Column
    ...
    public function testGetColumn(): void
    {
        ...
        //    get a \PhpSpreadsheet\Worksheet\Worksheet\AutoFilter\Column object returned
        foreach ($columnIndexes as $columnIndex) {
