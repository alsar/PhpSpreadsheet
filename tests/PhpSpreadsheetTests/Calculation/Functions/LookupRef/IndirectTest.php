...
use PhpSpreadsheet\Reader\Xlsx as ReaderXlsx;
...
class IndirectTest extends AllSetupTeardown
{
    ...
    public function testDeprecatedCall(): void
    {
        ...
        $result = /** @scrutinizer ignore-deprecated */ \PhpSpreadsheet\Calculation\LookupRef::INDIRECT('A2', $sheet->getCell('A1'));
        $result = \PhpSpreadsheet\Calculation\Functions::flattenSingleValue($result);
