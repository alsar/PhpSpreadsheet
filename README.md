...
[![Build Status](https://github.com/alsar/PhpSpreadsheet/workflows/main/badge.svg)](https://github.com/alsar/PhpSpreadsheet/actions)
[![Code Quality](https://scrutinizer-ci.com/g/alsar/PhpSpreadsheet/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/alsar/PhpSpreadsheet/?branch=master)
[![Code Coverage](https://scrutinizer-ci.com/g/alsar/PhpSpreadsheet/badges/coverage.png?b=master)](https://scrutinizer-ci.com/g/alsar/PhpSpreadsheet/?branch=master)
[![Total Downloads](https://img.shields.io/packagist/dt/alsar/PhpSpreadsheet)](https://packagist.org/packages/alsar/PhpSpreadsheet)
[![Latest Stable Version](https://img.shields.io/github/v/release/alsar/PhpSpreadsheet)](https://packagist.org/packages/alsar/PhpSpreadsheet)
[![License](https://img.shields.io/github/license/alsar/PhpSpreadsheet)](https://packagist.org/packages/alsar/PhpSpreadsheet)
[![Join the chat at https://gitter.im/alsar/PhpSpreadsheet](https://img.shields.io/badge/GITTER-join%20chat-green.svg)](https://gitter.im/alsar/PhpSpreadsheet)
...
```sh
composer require alsar/PhpSpreadsheet
```
...
Settings::setChartRenderer(\PhpSpreadsheet\Chart\Renderer\JpGraph::class);
//or
// to use mitoteam/jpgraph
Settings::setChartRenderer(\PhpSpreadsheet\Chart\Renderer\MtJpGraphRenderer::class);
```
...
Please ask your support questions on [StackOverflow](https://stackoverflow.com/questions/tagged/phpspreadsheet), or have a quick chat on [Gitter](https://gitter.im/alsar/PhpSpreadsheet).
...
PhpSpreadsheet is licensed under [MIT](https://github.com/alsar/PhpSpreadsheet/blob/master/LICENSE).
